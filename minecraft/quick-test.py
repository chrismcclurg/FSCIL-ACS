...
#model parameters
pFileNo         = 0                     #for writing results (doesn't matter in quick-test)
pMod            = 1                     #ACS modulation factor (see paper)
pSeed           = 0                     #random seed
pDataName       = 'cifar100'            #standard dataset (cifar100, grocery)
pLearner        = 'CBCLPR'              #classifier (SVM, CBCLWVS, CBCLSVM, CBCLPR)
pBias           = 'classWt'             #bias type in active class selection
pNetType        = 'resnet34'            #CNN type (for feature extractor)
pNetFit         = 'imagenet'            #pretrained weights (for feature extractor)
